     ...
     <div class="pcoded-inner-navbar main-menu">
         <div class="">
             <div class="main-menu-header">
             	<c:if test="${fotoUser != null && fotoUser != ''}">
	               	<img class="img-60 img-radius" src="${fotoUser}" alt="Imagem do Usuário">
             	</c:if>
             	<c:if test="${fotoUser == null || fotoUser == ''}">
             		<img class="img-60 img-radius" src="assets/images/do-utilizador.png" class="img-radius" alt="Imagem do Usuário">
             	</c:if>
